...
static void create() {
    ...
    SetExits( ([
        "south" : "/domains/diku-alfa/room/36.zon/3616",
        "west" : "/domains/diku-alfa/room/36.zon/3612",// Was east in tinyworld.wld diku file. Chnaged for consistancy.
        "down" : "/domains/diku-alfa/room/36.zon/3615",                
        ]) );
