...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/36.zon/rm_3601",
        "south" : "/domains/diku-alfa/room/36.zon/rm_3603",
        ]) );
}
...
Room name: A Gravel Road on the Graveyard, Of zone : 6. V-Number : 3602, R-number : 129
