...
static void create() {
    ...
    SetExits( ([
        "up" : "/domains/diku-alfa/room/36.zon/rm_3646",
        ]) );
    SetDoor("up", "/domains/diku-alfa/room/doors/3646_3647");
}
...
Room name: In a dusty Tomb, Of zone : 6. V-Number : 3647, R-number : 156
