...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/36.zon/rm_3646",
        "west" : "/domains/diku-alfa/room/36.zon/rm_3642",
        "down" : "/domains/diku-alfa/room/36.zon/rm_3645",                
        ]) );
    SetObviousExits("north, west");
    SetDoor("down", "/domains/diku-alfa/room/doors/3644_3645");
}
...
Room name: A Gravel Path on the Graveyard, Of zone : 6. V-Number : 3644, R-number : 153
