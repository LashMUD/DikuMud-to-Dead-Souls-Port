...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/36.zon/rm_3642",
        "south" : "/domains/diku-alfa/room/36.zon/rm_3638",
        "down" : "/domains/diku-alfa/room/36.zon/rm_3641",                
        ]) );
    SetObviousExits("north, south");
    SetDoor("down", "/domains/diku-alfa/room/doors/3640_3641");
}
...
Room name: A Gravel Path on the Graveyard, Of zone : 6. V-Number : 3640, R-number : 149
