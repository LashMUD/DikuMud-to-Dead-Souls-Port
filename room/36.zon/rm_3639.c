...
static void create() {
    ...
    SetExits( ([
        "up" : "/domains/diku-alfa/room/36.zon/rm_3638",
        ]) );
    SetDoor("up", "/domains/diku-alfa/room/doors/3638_3639");
}
...
Room name: In a dusty Tomb, Of zone : 6. V-Number : 3639, R-number : 148
