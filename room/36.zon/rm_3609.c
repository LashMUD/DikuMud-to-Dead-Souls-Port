...
static void create() {
    ...
    SetExits( ([
        "up" : "/domains/diku-alfa/room/36.zon/rm_3608",
        ]) );
    SetDoor("up", "/domains/diku-alfa/room/doors/3608_3609");
}
...
Room name: In a dusty Tomb, Of zone : 6. V-Number : 3609, R-number : 136
