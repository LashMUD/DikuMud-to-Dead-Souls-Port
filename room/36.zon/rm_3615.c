...
static void create() {
    ...
    SetExits( ([
        "up" : "/domains/diku-alfa/room/36.zon/rm_3614",
        ]) );
    SetDoor("up", "/domains/diku-alfa/room/doors/3614_3615");
}
...
Room name: In a dusty Tomb, Of zone : 6. V-Number : 3615, R-number : 142
