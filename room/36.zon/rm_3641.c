...
static void create() {
    ...
    SetExits( ([
        "up" : "/domains/diku-alfa/room/36.zon/rm_3640",
        ]) );
    SetDoor("up", "/domains/diku-alfa/room/doors/3640_3641");
}
...
Room name: In a dusty Tomb, Of zone : 6. V-Number : 3641, R-number : 150
