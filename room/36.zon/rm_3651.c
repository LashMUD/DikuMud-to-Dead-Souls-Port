...
static void create() {
    ...
    SetExits( ([
        "up" : "/domains/diku-alfa/room/36.zon/rm_3650",
        ]) );
    SetDoor("up", "/domains/diku-alfa/room/doors/3650_3651");
}
...
Room name: In a dusty Tomb, Of zone : 6. V-Number : 3651, R-number : 160
