...
static void create() {
    ...
    SetExits( ([
        "up" : "/domains/diku-alfa/room/36.zon/rm_3618",
        ]) );
    SetDoor("up", "/domains/diku-alfa/room/doors/3618_3619");
}
...
Room name: In a dusty Tomb, Of zone : 6. V-Number : 3619, R-number : 146
