...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/36.zon/rm_3650",
        "east" : "/domains/diku-alfa/room/36.zon/rm_3646",
        "down" : "/domains/diku-alfa/room/36.zon/rm_3649",                
        ]) );
    SetObviousExits("north, east");
    SetDoor("down", "/domains/diku-alfa/room/doors/3648_3649");
}
...
Room name: A Gravel Path on the Graveyard, Of zone : 6. V-Number : 3648, R-number : 157
