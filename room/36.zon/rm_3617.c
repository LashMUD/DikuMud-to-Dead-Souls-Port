...
static void create() {
    ...
    SetInventory( ([
        "/domains/diku-alfa/room/36.zon/npc/3602_ghoul" : 1,
        ]) );
    SetExits( ([
        "up" : "/domains/diku-alfa/room/36.zon/rm_3616",
        ]) );
    SetDoor("up", "/domains/diku-alfa/room/doors/3616_3617");
}
...
Room name: In a dusty Tomb, Of zone : 6. V-Number : 3617, R-number : 144
