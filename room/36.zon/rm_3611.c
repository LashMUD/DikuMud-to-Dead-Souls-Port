...
static void create() {
    ...
    SetInventory( ([
        ...
        "/domains/diku-alfa/room/36.zon/weap/3613_silver_dagger" : 1,
        ]) );
    SetExits( ([
        "up" : "/domains/diku-alfa/room/36.zon/rm_3610",
        ]) );
   SetDoor("up", "/domains/diku-alfa/room/doors/3610_3611");
}
...
Room name: In a dusty Tomb, Of zone : 6. V-Number : 3611, R-number : 138
