...
static void create() {
    ...
    SetExits( ([
        "up" : "/domains/diku-alfa/room/36.zon/rm_3606",
        ]) );
    SetDoor("up", "/domains/diku-alfa/room/doors/3606_3607");
}
...
Room name: In a dusty Tomb, Of zone : 6. V-Number : 3607, R-number : 134
