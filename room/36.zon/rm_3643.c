...
static void create() {
    ...
    SetExits( ([
        "up" : "/domains/diku-alfa/room/36.zon/rm_3642",
        ]) );
    SetDoor("up", "/domains/diku-alfa/room/doors/3642_3643");
}
...
Room name: In a dusty Tomb, Of zone : 6. V-Number : 3643, R-number : 152
