...
static void create() {
    ...
    SetExits( ([
        "east" : "/domains/diku-alfa/room/36.zon/rm_3644",
        "south" : "/domains/diku-alfa/room/36.zon/rm_3640",
        "down" : "/domains/diku-alfa/room/36.zon/rm_3643",                
        ]) );
    SetObviousExits("east, south");
    SetDoor("down", "/domains/diku-alfa/room/doors/3642_3643");
}
...
Room name: A Gravel Path on the Graveyard, Of zone : 6. V-Number : 3642, R-number : 151
