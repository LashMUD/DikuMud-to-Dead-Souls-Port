...
static void create() {
    ...
    SetExits( ([
        "south" : "/domains/diku-alfa/room/36.zon/rm_3616",
        "west" : "/domains/diku-alfa/room/36.zon/rm_3612",// Was east in tinyworld.wld diku file. Chnaged for consistancy.
        "down" : "/domains/diku-alfa/room/36.zon/rm_3615",                
        ]) );
    SetObviousExits("south, west");
    SetDoor("down", "/domains/diku-alfa/room/doors/3614_3615");
}
...
Room name: A Gravel Path on the Graveyard, Of zone : 6. V-Number : 3614, R-number : 141
