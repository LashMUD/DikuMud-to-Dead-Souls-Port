...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/36.zon/rm_3600",
        "south" : "/domains/diku-alfa/room/36.zon/rm_3602",
    ]) );
}
...
Room name: A Gravel Road on the Graveyard, Of zone : 6. V-Number : 3601, R-number : 128
