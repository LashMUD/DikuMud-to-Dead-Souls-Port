...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/60.zon/rm_6015",
        "south" : "/domains/diku-alfa/room/60.zon/rm_6017",
        ] ));
}
...
Room name: A small path in the dense forest, Of zone : 11. V-Number : 6016,
R-number : 337
