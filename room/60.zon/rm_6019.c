...
static void create() {
    ...
    SetItems( ([ 
        ...
        "east" : "The small path leads east through the trees to a lighter part of the forest.",
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/60.zon/rm_6020",
        "east" : "/domains/diku-alfa/room/60.zon/rm_6018",
        ] ));
}
...
Room name: A small path in the dense forest, Of zone : 11. V-Number : 6019,
R-number : 340
