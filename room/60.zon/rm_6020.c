...
static void create() {
    ...
    SetExits( ([
        "south" : "/domains/diku-alfa/room/60.zon/rm_6019",
        "west" : "/domains/diku-alfa/room/60.zon/rm_6021",
        ] ));
}
...
Room name: A small path in the dense forest, Of zone : 11. V-Number : 6020,
R-number : 341
