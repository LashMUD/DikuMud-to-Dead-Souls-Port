...
static void create() {
    ...
    SetInventory( ([
        "domains/diku-alfa/room/61.zon/npc/6111_tree_ancient" : 1,
        "/domains/diku-alfa/room/61.zon/weap/6104_branch" : 1,
        ]) );
    SetExits( ([
        "north" : "/domains/diku-alfa/room/61.zon/rm_6104",
        "west" : "/domains/diku-alfa/room/61.zon/rm_6106",
        ] ));
}
