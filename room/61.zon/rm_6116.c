...
static void create() {
    ...
    SetInventory( ([
        "domains/diku-alfa/room/61.zon/npc/6100_warg_vicious" : 2,
        ] ));
    SetExits( ([
        "east" : "/domains/diku-alfa/room/61.zon/rm_6117",
        "south" : "/domains/diku-alfa/room/61.zon/rm_6115",
        ] ));
}
...
Room name: A small path in the deep, dark forest, Of zone : 12. V-Number : 6116, R-number : 361
