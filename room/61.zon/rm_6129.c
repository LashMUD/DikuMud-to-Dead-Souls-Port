...
static void create() {
    ...
    SetExits( ([
        "east" : "/domains/diku-alfa/room/61.zon/rm_6128",
        "west" : "/domains/diku-alfa/room/61.zon/rm_6135",
        ] ));
}
...
Room name: A narrow trail through the deep, dark forest, Of zone : 12. V-Number : 6129, R-number : 374
