...
static void create() {
    ...
    SetInventory( ([
        "/domains/diku-alfa/room/61.zon/obj/6103_branch_light" : 1,
        ]) );
    SetExits( ([
        "south" : "/domains/diku-alfa/room/61.zon/rm_6114",
        "west" : "/domains/diku-alfa/room/61.zon/rm_6112",
        ] ));
}
