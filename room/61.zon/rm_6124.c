...
static void create() {
    ...
    SetAmbientLight(0);
    SetShort("A dead end path in the deep, dark forest");
    ...
    SetExits( ([
        "west" : "/domains/diku-alfa/room/61.zon/rm_6123",
        ] ));
}
...
Room name: A dead end path in the deep, dark forest, Of zone : 12. V-Number : 6124, R-number : 369
