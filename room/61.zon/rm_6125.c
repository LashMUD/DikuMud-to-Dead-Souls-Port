...
static void create() {
    ...
    SetAmbientLight(0);
    SetShort("A small path on the river bank in the deep, dark forest");
    ...
    SetInventory( ([
       "/domains/diku-alfa/room/61.zon/weap/6104_branch" : 1,
        ]) );
    SetExits( ([
        "north" : "/domains/diku-alfa/room/61.zon/rm_6126",
        "east" : "/domains/diku-alfa/room/61.zon/rm_6123",
        ] ));
}
...
Room name: A small path on the river bank in the deep, dark forest, Of zone : 12. V-Number : 6125, R-number : 370
