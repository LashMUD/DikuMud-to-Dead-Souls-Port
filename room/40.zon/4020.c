...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/40.zon/4027",
        "down" : "/domains/diku-alfa/room/40.zon/4064",
        ] ) );
}
...
/* NO_NPC's except room inventory allowed in room*/
int CanReceive(object ob) {
    if(ob && !inherits(LIB_NPC, ob) | !strcmp("a small centipede", ob->GetShort())){
    return 1;
    }
    else{
    return 0;
