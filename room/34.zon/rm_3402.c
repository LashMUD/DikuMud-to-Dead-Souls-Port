...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/34.zon/rm_3401",
        "south" : "/domains/diku-alfa/room/34.zon/rm_3403",
        ]) );
}
...
Room name: A Gravel Road on the Graveyard, Of zone : 5. V-Number : 3402, R-number : 119
