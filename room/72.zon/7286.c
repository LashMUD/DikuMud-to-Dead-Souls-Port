...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/72.zon/7285",
        "west" : "/domains/diku-alfa/room/72.zon/7283",
        ] ));
}
...
/* NO_NPC's except the Mudmonsters allowed in room*/
int CanReceive(object ob) {
    if(ob && !inherits(LIB_NPC, ob) | !strcmp("The horrifying Mudmonster", ob->GetShort())){
    return 1;
    }
    else{
    return 0;
