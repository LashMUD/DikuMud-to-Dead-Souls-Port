...
static void create() {
    ...
    SetInventory( ([
        "/domains/diku-alfa/room/72.zon/npc/7201_mindflayer_senior" :1,
        ]) );
    SetExits( ([
        "north" : "/domains/diku-alfa/room/72.zon/rm_7202",
        "east" : "/domains/diku-alfa/room/72.zon/rm_7206",
        "south" : "/domains/diku-alfa/room/72.zon/rm_7204",
        ] ));
}
...
Room name: The Lair, Of zone : 16. V-Number : 7203, R-number : 485
