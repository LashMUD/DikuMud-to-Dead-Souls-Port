...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/72.zon/7205",
        "south" : "/domains/diku-alfa/room/72.zon/7207",
        "west" : "/domains/diku-alfa/room/72.zon/7203",
        ] ));
}
...
int CanReceive(object ob) {
    if(ob && (!inherits(LIB_NPC, ob) | !strcmp("a strange white skull", ob->GetShort()))){
    return 1;
    }
    else
    return 0;
