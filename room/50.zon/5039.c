...
static void create() {
    ...
    SetExits( ([
        "west" : "/domains/diku-alfa/room/50.zon/5037",
        ] ));
...
mixed recite_scroll(string str){
    ...
    if(sizeof(scroll) <=0 || sizeof(ivy) <=0 || sizeof(jar) <=0 || sizeof(people) <=0 ) return 0;
    ...
    foreach(object player in people){
        ...
        player->eventMove("/domains/diku-alfa/room/50.zon/5040");
    }        
