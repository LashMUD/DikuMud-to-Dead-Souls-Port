...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/70.zon/rm_7064",
        "south" : "/domains/diku-alfa/room/70.zon/rm_7066",
        ] ));
}
...
Room name: The Watery sewer, Of zone : 14. V-Number : 7065, R-number : 448
