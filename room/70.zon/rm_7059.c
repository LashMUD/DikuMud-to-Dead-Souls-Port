...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/70.zon/rm_7058",
        "south" : "/domains/diku-alfa/room/70.zon/rm_7060",
        ] ));
}
...
Room name: The dark passageway, Of zone : 14. V-Number : 7059, R-number : 442
