...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/70.zon/rm_7066",
        "south" : "/domains/diku-alfa/room/70.zon/rm_7068",
        ] ));
}
...
Room name: The Watery sewer, Of zone : 14. V-Number : 7067, R-number : 450
