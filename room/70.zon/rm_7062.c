...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/70.zon/rm_7061",
        "south" : "/domains/diku-alfa/room/70.zon/rm_7063",
        ] ));
}
...
Room name: The Watery sewer, Of zone : 14. V-Number : 7062, R-number : 445
