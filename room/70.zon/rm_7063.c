...
static void create() {
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/70.zon/rm_7062",
        "south" : "/domains/diku-alfa/room/70.zon/rm_7064",
        ] ));
}
...
Room name: The Watery sewer, Of zone : 14. V-Number : 7063, R-number : 446
