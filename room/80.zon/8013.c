...
static void create() {
    ...
    SetItems( ([ 
        ...
        "south" : "The glass stretches all the way to the horizon, along the crack.",
    ...
    SetExits( ([
        "north" : "/domains/diku-alfa/room/80.zon/8002",
        "east" : "/domains/diku-alfa/room/80.zon/8014",
        "south" : "/domains/diku-alfa/room/80.zon/8023",
        ] ));
}
...
Room name: Main Matrix, Of zone : 20. V-Number : 8013, R-number : 596
