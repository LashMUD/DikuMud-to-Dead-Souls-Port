...
static void create() {
    ...
    SetExits( ([
        "east" : "/domains/diku-alfa/room/32.zon/rm_3205",
        "west" : "/domains/diku-alfa/room/32.zon/rm_3203",
        ]) );
}
...
Room name: On the River, Of zone : 3. V-Number : 3204, R-number : 106
