...
static void create() {
    ...
    SetExits( ([
        "east" : "/domains/diku-alfa/room/71.zon/7103",
        ] ));
}
...
/* NO_NPC's except the slithering snake allowed in room*/
int CanReceive(object ob) {
    if(ob && !inherits(LIB_NPC, ob) | !strcmp("the slithering snake", ob->GetShort())){
    return 1;
    }
    else
    return 0;
