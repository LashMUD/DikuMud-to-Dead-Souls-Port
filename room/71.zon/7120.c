...
static void create() {
    ...
    SetItems( ([ 
        "east" : "East. You stare into darkness.",
    ...
    SetExits( ([
        "east" : "/domains/diku-alfa/room/71.zon/7123",
        "south" : "/domains/diku-alfa/room/71.zon/7121",
        "west" : "/domains/diku-alfa/room/71.zon/7114",
        ] ));
}
...
Room name: The narrow eastern ledge, Of zone : 15. V-Number : 7120, R-number : 474
